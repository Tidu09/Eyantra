...
(cl:defmethod cl:initialize-instance :after ((m <vacuumGripper-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'vacuumGripper-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pkg_task2-srv:<vacuumGripper-request> is deprecated: use pkg_task2-srv:vacuumGripper-request instead.")))
...
(cl:defmethod activate_vacuum_gripper-val ((m <vacuumGripper-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pkg_task2-srv:activate_vacuum_gripper-val is deprecated.  Use pkg_task2-srv:activate_vacuum_gripper instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<vacuumGripper-request>)))
  ...
  "pkg_task2/vacuumGripperRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'vacuumGripper-request)))
  "Returns string type for a service object of type 'vacuumGripper-request"
  "pkg_task2/vacuumGripperRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <vacuumGripper-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'vacuumGripper-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pkg_task2-srv:<vacuumGripper-response> is deprecated: use pkg_task2-srv:vacuumGripper-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <vacuumGripper-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pkg_task2-srv:result-val is deprecated.  Use pkg_task2-srv:result instead.")
  (result m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<vacuumGripper-response>)))
  ...
  "pkg_task2/vacuumGripperResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'vacuumGripper-response)))
  "Returns string type for a service object of type 'vacuumGripper-response"
  "pkg_task2/vacuumGripperResponse")
