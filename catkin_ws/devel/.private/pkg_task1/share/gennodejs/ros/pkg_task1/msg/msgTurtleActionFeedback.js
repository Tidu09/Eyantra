...
class msgTurtleActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new msgTurtleFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = msgTurtleFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new msgTurtleActionFeedback(null);
    ...
    data.feedback = msgTurtleFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new msgTurtleActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = msgTurtleFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new msgTurtleFeedback()
    }
...
module.exports = msgTurtleActionFeedback;
