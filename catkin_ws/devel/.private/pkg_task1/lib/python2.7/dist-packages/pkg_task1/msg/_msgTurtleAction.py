...
"""autogenerated by genpy from pkg_task1/msgTurtleAction.msg. Do not edit."""
import codecs
import sys
...
import genpy
import pkg_task1.msg
import std_msgs.msg

class msgTurtleAction(genpy.Message):
  _md5sum = "a2f318f1e2bbea01bb0f1e3062ecba3f"
  _type = "pkg_task1/msgTurtleAction"
...
"""
  ...
  _slot_types = ['pkg_task1/msgTurtleActionGoal','pkg_task1/msgTurtleActionResult','pkg_task1/msgTurtleActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(msgTurtleAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = pkg_task1.msg.msgTurtleActionGoal()
      if self.action_result is None:
        self.action_result = pkg_task1.msg.msgTurtleActionResult()
      if self.action_feedback is None:
        self.action_feedback = pkg_task1.msg.msgTurtleActionFeedback()
    else:
      self.action_goal = pkg_task1.msg.msgTurtleActionGoal()
      self.action_result = pkg_task1.msg.msgTurtleActionResult()
      self.action_feedback = pkg_task1.msg.msgTurtleActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2b3I().pack(_x.action_goal.goal.distance, _x.action_goal.goal.angle, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3b3I().pack(_x.action_result.result.final_x, _x.action_result.result.final_y, _x.action_result.result.final_theta, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3b().pack(_x.action_feedback.feedback.cur_x, _x.action_feedback.feedback.cur_y, _x.action_feedback.feedback.cur_theta))
